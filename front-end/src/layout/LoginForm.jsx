...
export default function LoginForm() {
  ...
  <div className="flex items-center  justify-center">
      ...
      <a href="./RegisterForm.jsx" className='bg-green-500 border-[2px] border-white rounded-[10px] w-[100px] h-[40px] text-center ml-3 text-white hover:bg-white hover:text-green-500 hover:border-green-500'>สมัครใหม่</a>
    </div>   
